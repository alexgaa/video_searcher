...
class Analysis {
     ...
     * @return type возращает найденое количество вхождений
     */
     ...
     * @param type $keywordStart ключь начала искомой строки
     * @param type $keywordEnd ключь конца искомой строки
     * @param type $startOffset смещение от начала строки
